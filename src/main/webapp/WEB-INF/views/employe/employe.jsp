    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            <div class="container-fluid">
                <div class="row">
                    <div class="col-lg-12">
                        <h1 class="page-header"><fmt:message code="common.employe.employes" /></h1>
                    </div>
                    <!-- /.col-lg-12 -->
                </div>
                <!-- /.row -->
            ...
            <div class="row">
            	<div class="col-lg-12">
            		<ol class="breadcrumb">
					  <li><a href="<c:url value="/employer/nouveau" />"><i class="fa fa-plus">&nbsp;<fmt:message code="common.ajouter" /></i></a></li>
                            ...
                            <table width="100%" class="table table-striped table-bordered table-hover" id="dataTables-example">
                                <thead>
                                    <tr>
                                        ...
                                        <th><fmt:message code="common.post" /></th>
                                        <th><fmt:message code="common.departement" /></th>
                                    </tr>
                                </thead>
                                <tbody>
                                ...
                                <c:forEach items="${employes }" var="employe">
                                	<tr class="odd gradeX">
                                		<td><img src="${employe.getPhoto() }" width="40px" height="40px"></td>
                                        <td>${employe.getNomEmpl()}</td>
                                        <td>${employe.getAdress()}</td>
                                        <td>${employe.getContrats().getTitrePoste()}</td>
                                        <td>${employe.getDepartement().getNomDep()}</td>
                                        <td class="center">
                                        	<c:url value="/employer/modifier/${employe.getIdEmpl() }" var="lienModifier" />
                                        	<a href="${lienModifier }"><i class="fa fa-edit">&nbsp;</i></a>
                                        	&nbsp;|&nbsp;
                                        	<a href="javascript:void(0);" data-toggle="modal" data-target="#modalEmploye${employe.getIdEmpl() }"><i class="fa fa-trash-o"></i></a>
	                                        	<div class="modal fade" id="modalEmploye${employe.getIdEmpl() }" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
													<div class="modal-dialog">
														<div class="modal-content">
															...
															<div class="modal-footer">
																...
																<c:url value="/employe/supprimer/${employe.getIdEmpl() }" var="urlSuppression" />
