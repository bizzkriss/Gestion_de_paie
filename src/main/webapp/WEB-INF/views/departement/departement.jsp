    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            ...
            <div class="row">
            	<div class="col-lg-12">
            		<ol class="breadcrumb">
					  <li><a href="<c:url value="/employer/departement/nouveau" />"><i class="fa fa-plus">&nbsp;<fmt:message code="common.ajouter" /></i></a></li>
                            ...
                            <table width="100%" class="table table-striped table-bordered table-hover" id="dataTables-example">
                                <thead>
                                    <tr>
                                        ...
                                        <th><fmt:message code="common.parent" /></th>
                                ...
                                <c:forEach items="${departements }" var="departement">
                                	<tr class="odd gradeX">
                                        <td>${departement.getNomDep()}</td>
                                        <td>${departement.getDepParent()}</td>
                                        <td>${departement.getGestionnaire()}</td>
                                        <td class="center">
                                        	<c:url value="/employer/departement/modifier/${departement.getIdDep() }" var="lienModifier" />
                                        	<a href="${lienModifier }"><i class="fa fa-edit">&nbsp;</i></a>
                                        	&nbsp;|&nbsp;
                                        	<a href="javascript:void(0);" data-toggle="modal" data-target="#modalDepartement${departement.getIdDep() }"><i class="fa fa-trash-o"></i></a>
	                                        	<div class="modal fade" id="modalDepartement${departement.getIdDep() }" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
													<div class="modal-dialog">
														<div class="modal-content">
															...
															<div class="modal-footer">
																...
																<c:url value="/employer/departement/supprimer/${departement.getIdDep() }" var="urlSuppression" />
