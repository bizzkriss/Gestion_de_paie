    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            <div class="container-fluid">
                <div class="row">
                    <div class="col-lg-12">
                        <h1 class="page-header"><fmt:message code="common.employe.contrat" /></h1>
                    </div>
                    <!-- /.col-lg-12 -->
                </div>
                <!-- /.row -->
            ...
            <div class="row">
            	<div class="col-lg-12">
            		<ol class="breadcrumb">
					  <li><a href="<c:url value="/employer/contrat/nouveau" />"><i class="fa fa-plus">&nbsp;<fmt:message code="common.ajouter" /></i></a></li>
                ...
                <div class="col-lg-12">
                    <div class="panel panel-primary">
                        <div class="panel-heading">
                            <fmt:message code="contrat.liste" />
                        </div>
                        <!-- /.panel-heading -->
                            ...
                            <table width="100%" class="table table-striped table-bordered table-hover" id="dataTables-example">
                                <thead>
                                    <tr>
                                        ...
                                        <th><fmt:message code="common.poste" /></th>
                                        <th><fmt:message code="common.typeContrat" /></th>
                                        <th><fmt:message code="common.salaire" />&nbsp;($)</th>
                                    </tr>
                                </thead>
                                <tbody>
                                ...
                                <c:forEach items="${contrats }" var="contrat">
                                	<tr class="odd gradeX">
                                		<td>${contrat.getRef()}</td>
                                        <td>${contrat.getEmploye().getNomEmpl()}</td>
                                        <td>${contrat.getTitrePoste()}</td>
                                        <td>${contrat.getTypeContrat()}</td>
                                        <td>${contrat.getSalaireBase()}</td>
                                        <td class="center">
                                        	<c:url value="/employer/modifier/${contrat.getIdContrat() }" var="lienModifier" />
                                        	<a href="${lienModifier }"><i class="fa fa-edit">&nbsp;</i></a>
                                        	&nbsp;|&nbsp;
                                        	<a href="javascript:void(0);" data-toggle="modal" data-target="#modalEmploye${contrat.getIdContrat() }"><i class="fa fa-trash-o"></i></a>
	                                        	<div class="modal fade" id="modalEmploye${contrat.getIdContrat() }" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
													<div class="modal-dialog">
														<div class="modal-content">
															...
															<div class="modal-footer">
																...
																<c:url value="/employe/supprimer/${contrat.getIdContrat() }" var="urlSuppression" />
