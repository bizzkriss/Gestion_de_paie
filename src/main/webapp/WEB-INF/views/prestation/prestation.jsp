    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            <div class="container-fluid">
                <div class="row">
                    <div class="col-lg-12">
                        <h2 align="center" class="page-header"><fmt:message code="common.employe.allPrestation" /></h2>
                    </div>
                    <!-- /.col-lg-12 -->
                </div>
                <!-- /.row -->
            ...
            <div class="row">
            	<div class="col-lg-12">
            		<ol class="breadcrumb">
					  <li><a href="<c:url value="/employer/prestation/nouveau" />"><i class="fa fa-plus">&nbsp;<fmt:message code="common.ajouter" /></i></a></li>
                ...
                <div class="col-lg-12">
                    <div class="panel panel-primary">
                        <div class="panel-heading">
                            <fmt:message code="prestation.liste" />
                        </div>
                        <!-- /.panel-heading -->
                        <div class="panel-body">
                            <table width="100%" class="table table-striped table-bordered table-hover" id="dataTables-example">
                                <thead>
                                    <tr>
                                    	<th><fmt:message code="common.employe" /></th>
                                    	<th><fmt:message code="common.date" /></th>
                                        <th><fmt:message code="common.heureDebut" /></th>
                                        <th><fmt:message code="common.heureFin" /></th>
                                        <th><fmt:message code="common.heurePrest" /></th>
                                        <th><fmt:message code="common.nomLieu" /></th>
                                    </tr>
                                </thead>
                                <tbody>
                                ...
                                <c:forEach items="${prestations }" var="prestation">
                                	<tr class="odd gradeX">
                                		<td>${prestation.getEmploye().getNomEmpl()}</td>
                                		<td>${prestation.getDatePrestation()}</td>
                                        <td>${prestation.getHeureDebut()}</td>
                                        <td>${prestation.getHeureFin()}</td>
                                        <td>${prestation.getHeurePrest()}</td>
                                        <td>${prestation.getLieu_affectation().getNomLieu()}</td>
                                        <td class="center">
                                        	<c:url value="/employer/prestation/modifier/${prestation.getIdPrest() }" var="lienModifier" />
                                        	<a href="${lienModifier }"><i class="fa fa-edit">&nbsp;</i></a>
                                        	&nbsp;|&nbsp;
                                        	<a href="javascript:void(0);" data-toggle="modal" data-target="#modalEmploye${prestation.getIdPrest() }"><i class="fa fa-trash-o"></i></a>
	                                        	<div class="modal fade" id="modalEmploye${prestation.getIdPrest() }" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
													<div class="modal-dialog">
														<div class="modal-content">
															...
															<div class="modal-footer">
																...
																<c:url value="/employer/prestation/supprimer/${prestation.getIdPrest() }" var="urlSuppression" />
