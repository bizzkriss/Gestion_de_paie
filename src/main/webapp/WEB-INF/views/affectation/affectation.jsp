    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            <div class="container-fluid">
                <div class="row">
                    <div class="col-lg-12">
                        <h2 align="center" class="page-header"><fmt:message code="common.employe.allAffectation" /></h2><br />
                    </div>
                    <!-- /.col-lg-12 -->
                </div>
                <!-- /.row -->
            ...
            <div class="row">
            	<div class="col-lg-12">
            		<ol class="breadcrumb">
					  <li><a href="<c:url value="/employer/affectation/nouveau" />"><i class="fa fa-plus">&nbsp;<fmt:message code="common.ajouter" /></i></a></li>
                ...
                <div class="col-lg-12">
                    <div class="panel panel-primary">
                        <div class="panel-heading">
                            <fmt:message code="common.employe.listAffectation" />
                        </div>
                        <!-- /.panel-heading -->
                        <div class="panel-body">
                            <table width="100%" class="table table-striped table-bordered table-hover" id="dataTables-example">
                                <thead>
                                    <tr>
                                    	<th><fmt:message code="common.codeLieu" /></th>
                                        <th><fmt:message code="common.nomLieu" /></th>
                                        <th><fmt:message code="common.gestionnaire" /></th>
                                        <th>Actions</th>
                                    </tr>
                                </thead>
                                <tbody>
                                ...
                                <c:forEach items="${affectations }" var="affectation">
                                	<tr class="odd gradeX">
                                		<td>${affectation.getCodeLieu()}</td>
                                        <td>${affectation.getNomLieu()}</td>
                                        <td>${affectation.getGestionnaire()}</td>
                                        <td class="center">
                                        	<c:url value="/employer/affectation/modifier/${affectation.getIdLieu() }" var="lienModifier" />
                                        	<a href="${lienModifier }"><i class="fa fa-edit">&nbsp;</i></a>
                                        	&nbsp;|&nbsp;
                                        	<a href="javascript:void(0);" data-toggle="modal" data-target="#modalEmploye${affectation.getIdLieu() }"><i class="fa fa-trash-o"></i></a>
	                                        	<div class="modal fade" id="modalEmploye${affectation.getIdLieu() }" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
													<div class="modal-dialog">
														<div class="modal-content">
															...
															<div class="modal-footer">
																...
																<c:url value="/employe/affectation/supprimer/${affectation.getIdLieu() }" var="urlSuppression" />
