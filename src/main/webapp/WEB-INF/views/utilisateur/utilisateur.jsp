    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            <div class="container-fluid">
                <div class="row">
                    <div class="col-lg-12">
                        <h1 class="page-header"><fmt:message code="common.paramettre.utilisateur" /></h1>
                    </div>
                    <!-- /.col-lg-12 -->
                </div>
                <!-- /.row -->
            ...
            <div class="row">
            	<div class="col-lg-12">
            		<ol class="breadcrumb">
					  <li><a href="<c:url value="/paramettre/utilisateur/nouveau" />"><i class="fa fa-plus">&nbsp;<fmt:message code="common.ajouter" /></i></a></li>
                        ...
                        <div class="panel-body">
                            <table width="100%" class="table table-striped table-bordered table-hover" id="dataTables-example">
                                ...
                                <c:forEach items="${utilisateurs }" var="utilisateur">
                                	<tr class="odd gradeX">
                                		<td><img src="${utilisateur.getPhoto() }" width="10%" height="10%"></td>
                                        <td>${utilisateur.getNom()}</td>
                                        <td>${utilisateur.getPrenom()}</td>
                                        <td>${utilisateur.getMail()}</td>
                                        <td class="center">
                                        	<c:url value="/paramettre/utilisateur/modifier/${utilisateur.getIdUtilisateur() }" var="lienModifier" />
                                        	<a href="${lienModifier }"><i class="fa fa-edit">&nbsp;</i></a>
                                        	&nbsp;|&nbsp;
                                        	<a href="javascript:void(0);" data-toggle="modal" data-target="#modalDepartement${utilisateur.getIdUtilisateur() }"><i class="fa fa-trash-o"></i></a>
	                                        	<div class="modal fade" id="modalDepartement${utilisateur.getIdUtilisateur() }" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
													<div class="modal-dialog">
														<div class="modal-content">
															...
															<div class="modal-footer">
																...
																<c:url value="/paramettre/utilisateur/supprimer/${utilisateur.getIdUtilisateur() }" var="urlSuppression" />
