    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            <div class="container-fluid">
                <div class="row">
                    <div class="col-lg-12">
                        <h2 class="page-header"><fmt:message code="common.paie.allPaie" /></h2>
                    </div>
                    <!-- /.col-lg-12 -->
                </div>
                <!-- /.row -->
            ...
            <div class="row">
            	<div class="col-lg-12">
            		<ol class="breadcrumb">
					  <li><a href="<c:url value="/paie/paiement/nouveau" />"><i class="fa fa-plus">&nbsp;<fmt:message code="common.ajouter" /></i></a></li>
                            ...
                            <table width="100%" class="table table-striped table-bordered table-hover" id="dataTables-example">
                                <thead>
                                    <tr>
                                        ...
                                        <th><fmt:message code="common.salaireBase" />&nbsp; ($/heure)</th>
                                        <th><fmt:message code="paiement.info" />&nbsp;($)</th>
                                        <th><fmt:message code="avantage.det" />&nbsp;($)</th>
                                ...
                                <c:forEach items="${salaires }" var="salaire">
                                	<tr class="odd gradeX">
                                        ...
                                        <td class="center">
                                        	...
                                        	&nbsp;|&nbsp;
                                        	<a href="javascript:void(0);" data-toggle="modal" data-target="#modalEmploye${salaire. getIdSalaire() }"><i class="fa fa-trash-o"></i></a>
	                                        	<div class="modal fade" id="modalEmploye${salaire. getIdSalaire() }" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
													<div class="modal-dialog">
														<div class="modal-content">
															...
															<div class="modal-footer">
																...
																<c:url value="/paie/paiement/supprimer/${salaire. getIdSalaire() }" var="urlSuppression" />
